Entendemos como 190 usuarios, 20 bucles y 3800 educationalData a borrar el límite de nuestra aplicación.
...
bucles que queremos que queremos. Los registros educacionales serán creadas y deberemos 
añadirlas a nuestro PopulateDatabase.xml (se cede uno a modo de prueba).

Posteriormente creamos un contador en Jmeter cuyo número de inicio sea la id de la primera educationalData que
se ha generado en mySql, donde su incremento sea de 1 y su nombre de variable counter_number por ejemplo. 
Buscamos el método get de delete e introducimos el nombre del contador (counter_value) como variable. Así
