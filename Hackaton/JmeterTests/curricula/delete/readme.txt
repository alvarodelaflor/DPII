...
se ha generado en mySql, donde su incremento sea de 1 y su nombre de variable counter_value por ejemplo. 
...
Dato a tener en cuenta es que en el apartado edit de la jobApplication debemos mirar en mySql cual es la ID de
cualquier curricula del usuario que está logueado. Si este usuario no tiene ninguna curricula deberá crearse.
