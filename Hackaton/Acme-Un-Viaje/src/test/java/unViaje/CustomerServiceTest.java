...
public class CustomerServiceTest extends AbstractTest {
	...
	protected void diver02(final String name, final String surname,final String email, final String phone,
		...
		try {
			...
			Customer actorSave = this.customerService.saveRegisterAsCustomer(actor);
			super.unauthenticate();

			this.authenticate("userAccont");
			Customer actorEdit = this.customerService.getCustomerByUserAccountId(LoginService.getPrincipal().getId());
			...
			this.customerService.saveRegisterAsCustomer(actorEdit);
