						...
						<ul class="navbar-nav">
								...
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="admin/dashboard.do" class="dropdown-item"><spring:message
												code="master.page.admin.dashboard" /></a> <a
											href="admin/actorList.do" class="dropdown-item"> <spring:message
												code="master.page.admin.actorList" />
										</a> <a href="admin/config.do" class="dropdown-item"> <spring:message
												code="master.page.admin.config" />
										</a>
									</div></li>
								<li class="nav-item dropdown"><a href="#"
									class="nav-link dropdown-toggle" data-toggle="dropdown"
									id="navbardrop"> <spring:message
											code="master.page.actor.profile" />
								</a>
									<div class="dropdown-menu">
										<a href="admin/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="admin/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a>
									</div></li>
								<li class="nav-item"><a href="admin/create.do"
									class="nav-link"> <spring:message
											code="master.page.admin.create" />
								</a></li>
								<li class="nav-item dropdown"><a href="mailbox/list.do"
									class="nav-link"><spring:message
											code="master.page.mailbox.list" /></a></li>
							</security:authorize>
							...
							<security:authorize access="hasRole('CLEANER')">
								<li class="nav-item dropdown"><a href="#"
									class="nav-link dropdown-toggle" data-toggle="dropdown"
									id="navbardrop"> <spring:message
											code="master.page.cleaner.employment" />
								</a>
									<div class="dropdown-menu">
										<a href="curricula/list.do" class="dropdown-item"> <spring:message
												code="curricula" />
										</a> <a href="jobApplication/cleaner/list.do"
								...
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="cleaner/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="cleaner/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a>
							...
							<security:authorize access="hasRole('TRANSPORTER')">
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="transporter/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="transporter/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a>
								...
								<li class="nav-item dropdown"><a href="#"
									class="nav-link dropdown-toggle" data-toggle="dropdown"
									id="navbardrop"> <spring:message
											code="master.page.transporter.transports" />
								</a>
									<div class="dropdown-menu">
										<a href="transport/transporter/list.do" class="dropdown-item">
											<spring:message code="master.page.transporter.transport.list" />
										</a> <a href="transport/transporter/listAll.do"
											class="dropdown-item"> <spring:message
												code="master.page.transporter.transport.listAll" />
										</a>
									</div></li>
								<li class="nav-item"><a href="transporter/myCustomers.do"
									class="nav-link"> <spring:message
											code="master.page.transporter.myCustomers" />
								</a></li>
								<li class="nav-item dropdown"><a href="mailbox/list.do"
									class="nav-link"><spring:message
											code="master.page.mailbox.list" /></a></li>
							...
							<security:authorize access="hasRole('REFEREE')">
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="referee/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="referee/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a>
							...
							<security:authorize access="hasRole('CUSTOMER')">
								...
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="customer/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="customer/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a>
									</div></li>
								<li class="nav-item"><a href="request/customer/list.do"
									class="nav-link"> <spring:message
							...
							<security:authorize access="hasRole('TRAVELAGENCY')">
								...
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="travelAgency/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="travelAgency/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a> <a href="accomodation/travelAgency/list.do"
											class="dropdown-item"> <spring:message
												code="master.page.accomodation.list" />
										</a> <a href="transport/travelAgency/list.do"
											class="dropdown-item"> <spring:message
												code="master.page.transport.list" />
										</a>
									</div></li>

								<li class="nav-item"><a
									href="transport/travelAgency/list.do" class="nav-link"> <spring:message
											code="master.page.transport.list" />
								</a></li>
								<li class="nav-item"><a href="finder/travelAgency/show.do"
									class="nav-link"> <spring:message
											code="master.page.accomodation.list" />
								</a></li>
							...
							<security:authorize access="hasRole('HOST')">
								...
								<li class="nav-item dropdown"><a href="#"
									...
									<div class="dropdown-menu">
										<a href="host/edit.do" class="dropdown-item"> <spring:message
												code="master.page.actor.edit" />
										</a> <a href="host/show.do" class="dropdown-item"> <spring:message
												code="master.page.actor.show" />
										</a> <a href="socialProfile/list.do" class="dropdown-item"> <spring:message
												code="master.page.socialProfile.list" />
										</a>
