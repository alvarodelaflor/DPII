				...
				<div class="form">
					<ul class="tab-group">
						<li class="tab "><a href="#signup"><spring:message
									code="master.page.registre" /></a></li>
						...
						<div id="login" style="display: block;">
							<form:form action="j_spring_security_check"
								...
								<div class="field-wrap">
									<label> <spring:message code="security.username" /><span
										class="req">*</span>
									</label>
								...
								<div class="field-wrap">
									<label> <spring:message code="security.password" /><span
										class="req">*</span>
									</label>
									...
									<div class="field-wrap">
										<a href="customer/create.do"
											class="btn btn-secondary btn-block"><spring:message
												code="register.user" /></a>
									</div>
									<div class="field-wrap">
										<a href="cleaner/create.do"
											class="btn btn-secondary btn-block"><spring:message
												code="register.cleaner" /></a>
									</div>
									<div class="field-wrap">
										<a href="transporter/create.do"
											class="btn btn-secondary btn-block"><spring:message
												code="register.trasporter" /></a>
									</div>
								</div>

								<div class="col-md-6">
									<div class="field-wrap">
										<a href="referee/create.do"
											class="btn btn-secondary btn-block"><spring:message
												code="register.referee" /></a>
									</div>
									<div class="field-wrap">
										<a href="host/create.do" class="btn btn-secondary btn-block"><spring:message
												code="register.host" /></a>
									</div>
									<div class="field-wrap">
										<a href="travelAgency/create.do"
											class="btn btn-secondary btn-block"><spring:message
												code="register.travelAgency" /></a>
									</div>
								</div>
							</div>
						</div>
