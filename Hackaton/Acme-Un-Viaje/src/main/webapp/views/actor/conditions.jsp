...
<hr>
<div class="container-flex" style="padding-left: 2.5em">
	<div class="row">
		<div class="col">
	...
	<div class="row">
		<div class="col">
			<p>Please read these Terms and Conditions ("Terms", "Terms and
				Conditions") carefully before using the http://www.Acme-Un-Viaje.com
				website (the "Service") operated by Acme-Un-Viaje ("us", "we", or
				"our").</p>
			...
			<p>
				...
				access the Service. The Terms and Conditions agreement for
				Acme-Un-Viaje has been created with the help of <a
					href="https://termsfeed.com/">TermsFeed</a>.
			</p>
		</div>
	</div>
	...
	<div class="row">
		<div class="col">
			...
			<p>You are responsible for safeguarding the password that you use
	...
	<div class="row">
		<div class="col">
			...
			<p>Our Service may contain links to third-party web sites or
				services that are not owned or controlled by Acme-Un-Viaje.</p>

			<p>Acme-Un-Viaje has no control over, and assumes no
				responsibility for, the content, privacy policies, or practices of
				any third party web sites or services. You further acknowledge and
				agree that Acme-Un-Viaje shall not be responsible or liable,
	...
	<div class="row">
		<div class="col">
			...
			<p>All provisions of the Terms which by their nature should
	...
	<div class="row">
		<div class="col">
			...
			<p>These Terms shall be governed and construed in accordance with
				the laws of Spain, without regard to its conflict of law provisions.</p>
	...
	<div class="row">
		<div class="col">
			...
			<p>By continuing to access or use our Service after those
