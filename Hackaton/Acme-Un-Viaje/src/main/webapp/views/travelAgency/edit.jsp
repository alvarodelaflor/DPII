...
<div class="container-fluid">
	<form:form class="formularioEdicion" method="POST"
		modelAttribute="travelAgency" onsubmit="return phonenumberval();"
		action="travelAgency/edit.do">
			...
			<div class="col-md-6">
				<fieldset>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<form:select multiple="false" path="creditCard.make" cssStyle="width: 100%">
					...
					<acme:textbox code="actor.CVV" path="creditCard.CVV"
						placeholder="123" cssError="col-md-4" cssLabel="col-md-3"
						cssInput="col-md-4" />
					<acme:textboxExpiration code="actor.expiration"
						path="creditCard.expiration" cssError="col-md-4"
						cssLabel="col-md-3" cssInput="col-md-4" />
				</fieldset>
			</div>
		</div>
