...
<div class="content">
	...
	<!-- 
	TODO: INERTED A BUG (BOTH BUTTONS REJECT APPLICATION)
	...
	-->
		<input type="button" value="<spring:message code='application.accept' />" onclick="window.location = 'application/company/reject.do?applicationId=${application.id}'" />
