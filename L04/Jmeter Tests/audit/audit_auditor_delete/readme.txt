Entendemos como 70 usuarios, 10 bucles y 700 auditorias a borrar el límite de nuestra aplicación.
...
"autogenerate_auditAndPosition.zip" en el que le indicamos el número de usuarios y el número de
bucles que queremos que queremos. Las auditorias y las position asociadas serán creadas y deberemos 
añadirlas a nuestro PopulateDatabase.xml
