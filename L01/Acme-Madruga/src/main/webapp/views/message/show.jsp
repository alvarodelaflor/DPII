...
<div class="content">
				<table>
    				...
    				<tr><td><spring:message code="msg.show.priority" /><jstl:out value="${msg.priority.value}"></jstl:out></td></tr>															          			
          			...
          			<a onclick="return confirmar('accion.html')" title="AcmeTitle" href="message/delete.do?id=${msg.id}&messageBoxId=${messageBoxId}"><img src="images/delete.png" alt="Delete" width="3%"/></a>
          			<form>
