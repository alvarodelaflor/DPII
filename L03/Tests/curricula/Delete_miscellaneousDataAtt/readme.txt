Entendemos como 264 usuarios, 32 bucles y 8448 registro a borrar el límite de nuestra aplicación.

A partir de esta configuración el login se eleva a casi dos segundos y medios, algo no usable para el día a
día de los usuarios.

El procedimiento ha sido crear un número de registros (hilos * iteraciones) usando el programa java 
"generateCurriculaMiscellaneousDataPopulate.zip" en el que le indicamos el número de entidades que queremos. Insertamos
