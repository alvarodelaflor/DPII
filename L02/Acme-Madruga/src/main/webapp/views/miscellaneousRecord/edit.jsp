...
<body>
	<div>
    	<form:form class="formularioEdicion" method="POST" modelAttribute="miscellaneousRecord" action="history/miscellaneousRecord/edit.do">
          	<form:hidden path="id"/>
          	<form:hidden path="version"/>
          	<fieldset>
          		<legend>
          			<spring:message code="miscellaneousRecord.dates" />
          		</legend>
