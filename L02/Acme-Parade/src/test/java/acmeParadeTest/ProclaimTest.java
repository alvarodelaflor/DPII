	...
	protected void checkTest(final String userName, final int textMin, final int textMax, final Class<?> expected) {
		...
		try {
			...
			if (textMin != 0 && textMax == 0)
				...
				proclaim
					.setText("Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium.");
			else
	...
	protected void checkTest(final String userName, final int textBlank, final int textMax, final int textNull, final Class<?> expected) {
		...
		try {
			...
			if (textBlank != 0 && textMax == 0 && textNull == 0)
				...
				proclaim
					.setText("Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium q");
