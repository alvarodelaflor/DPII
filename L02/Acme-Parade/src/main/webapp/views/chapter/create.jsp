...
<section id="main-content">
	<article>
		<div class="content">
				...
				modelAttribute="registrationForm" onsubmit="return phonenumberval();"  action="chapter/create.do">
				...
				<acme:password code="chapter.passwordC" path="confirmPassword" />
				...
				<acme:phonebox code="chapter.phone" path="phone"/>
