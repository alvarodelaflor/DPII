...
<%@ taglib prefix="acme" tagdir="/WEB-INF/tags" %>
	...
	<div>
		<jstl:if test="${request.status eq null}">
			<form method="get">
				<button formaction="/Acme-Parade/request/member/delete.do" name="requestId" value="${request.id }"><spring:message code="request.delete"/></button>
				<button formaction="/Acme-Parade/request/member/list.do"><spring:message code="back"/></button>
			</form>
		</jstl:if>
	</div>
	<div>
